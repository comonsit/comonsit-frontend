    ...
    if (this.props.selectedSol) {
      solicitudInfo = (
        <div className={classes.infoDiv}>
          ...
          <p><b><FormattedMessage id="nombre_productor"/>:</b> {this.props.selectedSol.clave_socio} nombres</p>
          <p><b><FormattedMessage id="clave"/>:</b> {this.props.selectedSol.clave_socio}</p>
          <p><b><FormattedMessage id="comunidad"/>:</b> {this.props.selectedSol.clave_socio} comunidad</p>
          <p><b><FormattedMessage id="region"/>:</b> {this.props.selectedSol.clave_socio} region</p>
          <p><b><FormattedMessage id="folio"/>:</b> {this.props.selectedSol.folio_solicitud}</p>
          <p><b><FormattedMessage id="area_proceso"/>:</b> {this.props.selectedSol.clave_socio} trabajador</p>
          ...
          <p><b><FormattedMessage id="mesaControl.ingresos_de_cooperativa"/>:</b> {this.props.selectedSol.clave_socio} ¿ingresos coop?</p>
          ...
          <p><b><FormattedMessage id="aval"/>:</b> {this.props.selectedSol.aval}</p>
          <p><b><FormattedMessage id="justificacion"/>:</b> {this.props.selectedSol.aval}</p>
          ...
          <p><b><FormattedMessage id="cargo"/>:</b> {this.props.selectedSol.clave_socio} cargo coomunitario</p>
          <p><b><FormattedMessage id="cargo_coop"/>:</b> {this.props.selectedSol.clave_socio} cargo coomunitario</p>
          <p><b><FormattedMessage id="cargo_mision"/>:</b> {this.props.selectedSol.clave_socio} cargo misión??</p>
          <p><b><FormattedMessage id="ingreso_a_YA"/>:</b> {this.props.selectedSol.clave_socio} año ingreso YA</p>
          <p><b><FormattedMessage id="mesaControl.porc_acopio_por_anio"/>:</b> ¿¿??</p>
          <br/>
          <p><b><FormattedMessage id="mesaControl.familiaresYA"/>:</b> ¿¿??</p>

          <p><b><FormattedMessage id="mesaControl.obsPromotor"/>:</b> {this.props.selectedSol.comentarios_promotor}</p>
        </div>
      )
    }
